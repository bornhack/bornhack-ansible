...
mv $TMPDIR $TARGETDIR
echo "New bornhack ansible put into production, revision https://github.com/tykling/bornhack-ansible/commit/${REV}" | mail -s "new bornhack ansible put in production" thomas@gibfest.dk
